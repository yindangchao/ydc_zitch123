package com.vanpro.zitech125.daemon.receiver;

import android.content.*;

import com.vanpro.zitech125.bluetooth.BluetoothLeService;
import com.vanpro.zitech125.daemon.service.LifecycleService;
import com.vanpro.zitech125.daemon.service.WorkService;
...
public class WakeUpReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null && ACTION_CANCEL_JOB_ALARM_SUB.equals(intent.getAction())) {
            LifecycleService.cancelJobAlarmSub();
            return;
        }
